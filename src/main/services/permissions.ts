...
export class PermissionStore {
  ...
  isAllowed(domain: string): boolean {
    ...
    return rule.action === 'allow'
      ...
      this.logger.error(`Failed to check if domain ${domain} is allowed:`, err)
      return false
    }
  ...
  isBlocked(domain: string): boolean {
    ...
    return rule.action === 'block'
      ...
      this.logger.error(`Failed to check if domain ${domain} is blocked:`, err)
      return false
    }
  ...
  close(): void {
    ...
    this.db.close()
      ...
      this.logger.error("Failed to close permissions database:", err)
    }
}
